...
namespace EditorNS
{
        ...
        BannerBasicMessage(parent)
    {
        ...
        QPushButton *tmp;
        if (mode == false) {
            message = "This file is indented with %1, but your settings specify to use %2.";
            if (current.useTabs) {
            ...
            message = "This file is indented with %1 spaces, but your settings specify to use %2 spaces.";

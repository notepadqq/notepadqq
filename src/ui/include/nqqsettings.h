...
#define NQQ_SETTING(Name, Type, Default)                                                                               \
    Type get##Name() const                                                                                             \
    { return _m_settings.value(_m_category + #Name, Default).value<Type>(); }                                          \
    void set##Name(const Type& newValue)                                                                               \
    { _m_settings.setValue(_m_category + #Name, newValue); }                                                           \
    Type reset##Name()                                                                                                 \
    {                                                                                                                  \
        _m_settings.setValue(_m_category + #Name, Default);                                                            \
        return Default;                                                                                                \
    }                                                                                                                  \
    bool has##Name() const                                                                                             \
    { return _m_settings.contains(_m_category + #Name); }

#define NQQ_SETTING_WITH_KEY(Name, Type, Default)                                                                      \
    Type get##Name(const QString& key) const                                                                           \
    { return _m_settings.value(_m_category + key + "/" #Name, Default).value<Type>(); }                                \
    void set##Name(const QString& key, const Type& newValue)                                                           \
    { _m_settings.setValue(_m_category + key + "/" #Name, newValue); }                                                 \
    Type reset##Name(const QString& key)                                                                               \
    {                                                                                                                  \
        _m_settings.setValue(_m_category + key + "/" #Name, Default);                                                  \
        return Default;                                                                                                \
    }                                                                                                                  \
    bool has##Name(const QString& key) const                                                                           \
    { return _m_settings.contains(_m_category + key + "/" #Name); }
...
#define BEGIN_CATEGORY(Name)                                                                                           \
    ...
    private:                                                                                                           \
        ...
        const QString _m_category = #Name "/";                                                                         \
                                                                                                                       \
    public:                                                                                                            \
        _Category##Name(QSettings& settings)                                                                           \
